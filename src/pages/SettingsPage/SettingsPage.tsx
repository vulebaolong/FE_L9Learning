...
function SettingsPage() {
    ...
    const btn = `transition flex items-center gap-2 py-[14px] px-[12px] rounded-lg hover:dark:!text-slate-200 hover:dark:!bg-[#e8ebed23] hover:!text-[#1a1a1a] hover:!bg-[#e8ebed]`;
    const para = `text-black/80 text-sm dark:text-slate-400`;

    return (
        <section className="container pb-24">
            <h1 className={`heading_1 my-5`}>Cài đặt</h1>
